...
4. To test the code on VM servers:  
	...
	![Remix Workspace 1](./Remix_Workspace_1.png)
...
![Remix Workspace with Metamask](./Remix_Workspace_with_Metamask.png)
![Remix Workspace after Thing.flag()](./Remix_Workspace_after_Thing.flag().png)
...
![Nile Console Output](./Nile_Console_Output.png)
...
![Example of Working Log](./Example_of_Working_Log.png)
